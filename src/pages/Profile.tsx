...
const Profile = () => {
  ...
  // Guard 2 — pas de user (ne devrait jamais arriver via ProtectedRoute, mais sécurité défensive)
  if (!user) return (
  ...
  // Guard 3 — profile Supabase pas encore arrivé (100–300ms après auth)
  if (!profile) return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center gap-4">
  ...
  // Toutes les valeurs null-safées
