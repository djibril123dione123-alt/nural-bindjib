...
const Auth = () => {
  ...
  // Check if 2 profiles already exist → lock signup
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4" style={{ paddingTop: "env(safe-area-inset-top)" }}>
      <motion.div
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {!isLogin && !signupLocked && (
                  <>
                    <div>
                      <label className="text-xs uppercase tracking-wider text-muted-foreground mb-1 block">Prénom</label>
                ...
                <div>
                  <label className="text-xs uppercase tracking-wider text-muted-foreground mb-1 block">E-mail</label>
                ...
                <div>
                  <label className="text-xs uppercase tracking-wider text-muted-foreground mb-1 block">Mot de passe</label>
          ...
          {!signupLocked && (
            <div className="text-center">
              <button onClick={() => setIsLogin(!isLogin)}
                ...
                {isLogin ? "Pas encore de compte ? Rejoindre l'Alliance" : "Déjà membre ? Se connecter"}
              </button>
            </div>
          )}
