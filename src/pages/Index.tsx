  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        {/* Sacred Clock — Le cœur battant du Sanctuaire (Correction effectuée ici) */}
        <SacredClock />

        {/* Bannière de sagesse quotidienne */}
        <WisdomBanner />
        ...
        {/* Barre de progression duale (Couple) */}
        <DualProgressBar />

        {/* Objectifs quotidiens (Targets) */}
        ...
        {/* Les 4 Piliers (Body, Mind, Faith, Life) */}
